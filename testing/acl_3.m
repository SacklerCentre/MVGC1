...
% make a lot more sense alongside the <matlab:open('mvgc_doc.pdf') reference
% document> [1], which we  _strongly recommend_ you consult, particularly
% Section 3 on design principles of the toolbox. You might also like to refer to
% the <mvgc_schema.html schema> of MVGC computational pathways -
% <mvgc_schema.html#3 algorithms> |A<n>| in this demo refer to the algorithm
% labels listed there - and the <mvgchelp.html#4 Common variable names and data
% structures> section of the Help documentation.
%
...
seed      = 23103;      % random seed (0 for unseeded)
...
F = autocov_to_pwcgc_test(G);
ptoc('*** autocov_to_pwcgc took');
