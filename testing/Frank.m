...
morder    = 12;     % model order to use ('actual', 'AIC', 'BIC' or supplied numerical value)
...
clear alltrialsdiv1000grangeramycalfglocofc

[nvars,nobs,ntrials] = size(X);

% Demean and normalise on a per-trial basis
