...
%
% Errors and diagnostics are returned in the |info| struct. Possible errors are
%
...
function [G,info] = var_to_autocov_old3(A,SIG,acmaxlags,acdectol,aitr,maxiters,maxrelerr)
